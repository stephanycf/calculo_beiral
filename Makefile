...
SOURCES = \
	__init__.py \
	calc_beiral.py calc_beiral_dialog.py

PLUGINNAME = calc_beiral

PY_FILES = \
	__init__.py \
	calc_beiral.py calc_beiral_dialog.py

UI_FILES = calc_beiral_dialog_base.ui
...
QGISDIR=C:\Users\conta\AppData/Roaming/QGIS/QGIS4/profiles/default/python/plugins
